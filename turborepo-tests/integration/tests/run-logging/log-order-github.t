...
because otherwise prysk interprets them as multiline commands
  ...
  ::group::my-app:build
  cache bypass, force executing c4254a39fc0a3fd7
  ...
  ::endgroup::
  ::group::util:build
  cache bypass, force executing 976c7787d6111b57
...
# Build as if we are in Github Actions with a task log prefix.
  ...
  \xe2\x80\xa2 Remote caching disabled (esc)
  ::group::util:build
  util:build: cache bypass, force executing 976c7787d6111b57
  util:build: 
  util:build: > build
...
Verify that errors are grouped properly
  ...
  cache miss, executing b5ffdbc4b7c12126
