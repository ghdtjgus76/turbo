...
Note that npm reports any failed script as exit code 1, even though we "exit 2"
  ...
  my-app:okay: cache miss, executing a61c1de1e73ca2b1
  my-app:okay: 
  my-app:okay: > okay
  my-app:okay: > echo working
  my-app:okay: 
  my-app:okay: working
  my-app:error: cache miss, executing 68f60b7829e5ac66
  my-app:error: 
  my-app:error: > error
  my-app:error: > exit 2
  my-app:error: 
...
Make sure error isn't cached
  ...
  \xe2\x80\xa2 Running error in 1 packages (esc)
  \xe2\x80\xa2 Remote caching disabled (esc)
  my-app:okay: cache hit, replaying logs a61c1de1e73ca2b1
  my-app:okay: 
  my-app:okay: > okay
  my-app:okay: > echo working
  my-app:okay: 
...
Make sure error code isn't swallowed with continue
  ...
  my-app:okay2: cache miss, executing 374f818ebbd18c13
  my-app:okay2: 
  my-app:okay2: > okay2
