...
baseline to generate cache
  ...
  my-app:build: cache miss, executing 153a6a7d4c933679
...
# env var=true, missing flag: cache bypass
  ...
  \xe2\x80\xa2 Running build in 1 packages (esc)
  \xe2\x80\xa2 Remote caching disabled (esc)
  my-app:build: cache bypass, force executing 153a6a7d4c933679
...
# env var=true, --flag=false: cache hit
  ...
  \xe2\x80\xa2 Running build in 1 packages (esc)
  \xe2\x80\xa2 Remote caching disabled (esc)
  my-app:build: cache hit, suppressing logs 153a6a7d4c933679
