...
# cache:false in root, override to cache:true in workspace
  ...
  cached:cached-task-1: cache miss, executing fd339d0d18093be7
...
# cache:true in root, override to cache:false in workspace
  ...
  \xe2\x80\xa2 Remote caching disabled (esc)
  cached:cached-task-2: cache bypass, force executing 80c7ee8943f75378
...
no `cache` config in root, cache:false in workspace
  ...
  \xe2\x80\xa2 Remote caching disabled (esc)
  cached:cached-task-3: cache bypass, force executing eac29fcb1cee6550
...
we already have a workspace that doesn't have a config
  ...
  \xe2\x80\xa2 Remote caching disabled (esc)
  missing-workspace-config:cached-task-4: cache bypass, force executing a02c45d6eef472de
